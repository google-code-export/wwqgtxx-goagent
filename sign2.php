...
/* Sign */
if($data=md5(file_get_contents("wwqgtxx-wallproxy/hash.dat"))){
	echo " Signing...";
	...
	$pubkey=file_get_contents("wwqgtxx-wallproxy/data/wwqgtxx-goagent.pubkey");
	...
	file_put_contents("wwqgtxx-wallproxy/sign.dat",base64_encode($signature));
}else{
